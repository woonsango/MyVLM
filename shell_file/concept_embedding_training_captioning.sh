...
do
    CUDA_VISIBLE_DEVICES=0,1,2 python3 ./concept_embedding_training/train.py --config_path example_configs/llava/concept_embedding_training_captioning/concept/"${concept}"_concept_embedding_training_captioning.yaml
done
