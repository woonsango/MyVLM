...
python3 ./example_configs/llava/concept_embedding_training_captioning/write_yaml.py
...
do
    CUDA_VISIBLE_DEVICES=5,6,7 python3 ./concept_embedding_training/train.py --config_path example_configs/llava/concept_embedding_training_captioning/concept/"${concept}"_concept_embedding_training_captioning.yaml
done
