...
# 특정 디렉토리 설정
DIRECTORY="./concept_head_training/"
...
# CUDA_VISIBLE_DEVICES=0,1,2 python3 ./concept_embedding_training/train.py --config_path example_configs/llava/concept_embedding_training_vqa/concept/cat_statue_concept_embedding_training_vqa.yaml
...
# CUDA_VISIBLE_DEVICES=0,1,3 python3 ./concept_embedding_training/train.py --config_path example_configs/llava/concept_embedding_training_vqa/concept/ceramic_head_concept_embedding_training_vqa.yaml
# CUDA_VISIBLE_DEVICES=0,1,3 python3 ./concept_embedding_training/train.py --config_path example_configs/llava/concept_embedding_training_vqa/concept/running_shoes_concept_embedding_training_vqa.yaml